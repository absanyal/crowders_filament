...
# ---Linker numbers---
n_skip_mem_linkers = 100  # Gap between two successive linkers
n_linkers_cross = 0
n_linkers_embedded = 0
...
with open(data_fname_str, 'w') as data_f:
    ...
    data_f.write('{} atoms\n'.format(n_atoms * n_chains +
                                     n_linkers_membrane + n_linkers_cross+n_linkers_embedded))
